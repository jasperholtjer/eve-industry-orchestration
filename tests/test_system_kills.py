...
@pytest.mark.parametrize(("asset", "_sensor", "_recent", "derivative"), _MEASURE_CASES)
def test_history_gold_materialises_ready_day(
    corpus, asset, _sensor, _recent, derivative
) -> None:
    _ingest(corpus, "2024-01-15")
